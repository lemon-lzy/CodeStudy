...
import com.lzy.codestudybackend.judge.codasandbox.CommonCodeSandBox;
...
import static com.lzy.codestudybackend.constant.CodeBlackList.C_SENSITIVE_WORD_LIST;
...
@Slf4j
@Component
public abstract class CCodeSandboxTemplate extends CommonCodeSandBox implements CodeSandbox {
    /**
     *
     */
     ...
     * 代码统一名称
     */
    private static final String GLOBAL_C_NAME = "Main.c";
...
//        }
    ...
    public ExecuteMessage compileFile(File userCodeFile) {
        ...
        //2.编译程序命令
        String compileCmd = String.format("gcc -o %sMain.exe %s", userCodeFile.getParent() + File.separator, userCodeFile.getAbsolutePath());
        if (osName.contains("nix") || osName.contains("nux")) {
            compileCmd = String.format("gcc -o %sMain %s", userCodeFile.getParent() + File.separator, userCodeFile.getAbsolutePath());
        }
        try {
